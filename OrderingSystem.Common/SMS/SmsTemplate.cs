...
namespace OrderingSystem.Common.SMS
{
    /// <summary>
    /// 短信模版
    /// </summary>
    public static class SmsTemplate
    {
        ...
        /// 用户支付成功给商家发送短信
        /// </summary>
        public static string SmsOrderNoToBusiness = ConfigurationManager.AppSettings["SmsOrderNoToBusiness"] == null ? "SMS_132105276" : ConfigurationManager.AppSettings["SmsOrderNoToBusiness"];
    }
}
