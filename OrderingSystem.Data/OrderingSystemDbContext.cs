namespace OrderingSystem.Data
{
    ...
    public class OrderingSystemDbContext : DbContext, IDbContext
    {
        public OrderingSystemDbContext()
            : base("name=OrderingSystemDB")
        {
            
        }

        public OrderingSystemDbContext(string nameOrConnectionString)
