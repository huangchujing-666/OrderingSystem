$(function () {
    var id = $('#id'),
        ...
        sellCountPerMonth = $('#sellCountPerMonth'),
    ...
    $('#btnSave').click(function () {
       ...
       // introduces = UE.getEditor('description').getContent();
        var dataArr = {
            ...
            DishesCategoryId: dishecategoryId.val(),
            BusinessInfoId: businessmanId.val(),
            SellCountPerMonth: sellCountPerMonth.val(),
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Status == 200) {
                    swal("提示", "操作成功");
                    setTimeout(function () {
                        window.location.href = '/Dishes/List?RefreshFlag=1';
                        //history.go(-1);
                    }, 1500);
                }
                if (data.Status == 202) {
